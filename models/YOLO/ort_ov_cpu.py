...
class Model(Model):
    """YOLO inference with using OpenVINO Execution Provider"""
    ...
    def __init__(self):
        ...
        try:
            ...
            pass
        self.sess = None
        self.sess_data = {'providers': ['OpenVINOExecutionProvider']}
        if self.sess_data['providers'][0] not in ort.get_available_providers():
            raise Exception('OpenVINO Execution Provider is not available')
